...
8, f & 255, 1] : 4 === l && (r = [(f & 3840) >> 4 | (f & 3840) >> 8, (f & 240) >> 4 | f & 240, (f & 15) << 4 | f & 15, 1])), !r)
...
k, '" filled\x3d"false" path\x3d"', H, '" coordsize\x3d"10 10" style\x3d"', p.style.cssText, '" /\x3e'], n = F(d.prepVML(h), null, {
    ...
    (function (a, C) {
        ...
        a.extend(C.prototype, {
            ...
            removePlotBandOrLine: function (a) {
                ...
                f([d.plotLines || [], k.plotLines || [], d.plotBands ||
[], k.plotBands || []], function (e) {
